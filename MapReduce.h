...
/// <summary>
/// Class MapReduce - MapReduce framework.
/// </summary>
/// <param name="mappers_count">Count of mappers.</param>
/// <param name="reducers_count">Count of reducers.</param>
/// <param name="work">Work directory.</param>
class MapReduce {
public:
